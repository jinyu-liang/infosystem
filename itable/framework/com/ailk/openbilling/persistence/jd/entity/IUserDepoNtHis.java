...
@NotModified
@Entity
@Table(schema="jd",name="I_USER_DEPO_NT_HIS")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(propOrder={"servId","promoId","condId","busiType","soNbr","changeFlag","srcType","regionCode","createDate","validDate","dealDate","dealCode","remark"})
public class IUserDepoNtHis extends DataObject{
	...
	@Column(name="DEAL_CODE",precision=8,columnDefinition="NUMBER",nullable=false)
	@XmlElement(name="dealCode")
	private Integer dealCode;

	@Column(name="REMARK",columnDefinition="Varchar",length=4000)
	...
	public void setDealCode(Integer obj){
		this.dealCode = obj;
	}
	...
	public IUserDepoNtHis(){
	}

	public boolean equals(final Object rhs0){
		if (rhs0 == null)return false;
		IUserDepoNtHis rhs=(IUserDepoNtHis)rhs0;
		...
		if(!ObjectUtils.equals(dealCode, rhs.dealCode)) return false;
...
public enum Field implements jef.database.Field{servId,promoId,condId,busiType,soNbr,changeFlag,srcType,regionCode,createDate,validDate,dealDate,dealCode,remark}
}