...
@NotModified
@Entity
@Table(schema="JD",name="I_BATCH_DATA_INDEX_SUB_2")
...
public class IBatchDataIndexSub3 extends DataObject{
	...
	public IBatchDataIndexSub3(){
	}

	public boolean equals(final Object rhs0){
		if (rhs0 == null)return false;
		IBatchDataIndexSub3 rhs=(IBatchDataIndexSub3)rhs0;
