...
@NotModified
@Entity
@Table(schema="JD",name="I_BATCH_DATA_INDEX_ERR")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(propOrder={"custId","acctId","userId","upField","regionCode","countyCode","commitDate","doneCode","soNbr","dealDate","errorCode","errorMsg","remark","busiCode"})
public class IBatchDataIndexErr extends DataObject{
	...
	@Column(name="REMARK",columnDefinition="Varchar",length=255,nullable=false)
	...
	public IBatchDataIndexErr(){
	}

	public boolean equals(final Object rhs0){
		if (rhs0 == null)return false;
		IBatchDataIndexErr rhs=(IBatchDataIndexErr)rhs0;
...
public enum Field implements jef.database.Field{custId,acctId,userId,upField,regionCode,countyCode,commitDate,doneCode,soNbr,dealDate,errorCode,errorMsg,remark,busiCode}
}