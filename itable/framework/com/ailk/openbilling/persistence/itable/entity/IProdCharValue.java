...
@NotModified
@Entity
@Table(schema="JD",name="I_PROD_CHAR_VALUE")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(propOrder={"productId","paramId","paramValue","validDate","expireDate","operType","soNbr","commitDate","userId","acctId","serviceId","objectType"})
public class IProdCharValue extends DataObject{
	...
	public IProdCharValue(){
	}

	public boolean equals(final Object rhs0){
		if (rhs0 == null)return false;
		IProdCharValue rhs=(IProdCharValue)rhs0;
...
public enum Field implements jef.database.Field{productId,paramId,paramValue,validDate,expireDate,operType,soNbr,commitDate,userId,acctId,serviceId,objectType}
}