...
@NotModified
@Entity
@Table(schema="JD",name="I_BATCH_DATA_INDEX_SUB")
...
public class IBatchDataIndexSub extends DataObject{
	...
	public IBatchDataIndexSub(){
	}

	public boolean equals(final Object rhs0){
		if (rhs0 == null)return false;
		IBatchDataIndexSub rhs=(IBatchDataIndexSub)rhs0;
