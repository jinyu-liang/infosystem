...
@NotModified
@Entity
@Table(schema="JD",name="I_USER_VALIDITY")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(propOrder={"userId","validDate","expireDate","operType","soNbr","commitDate"})
public class IUserValidity extends DataObject{
	...
	public IUserValidity(){
	}

	public boolean equals(final Object rhs0){
		if (rhs0 == null)return false;
		IUserValidity rhs=(IUserValidity)rhs0;
...
public enum Field implements jef.database.Field{userId,validDate,expireDate,operType,soNbr,commitDate}
}