...
@NotModified
@Entity
@Table(schema="JD",name="I_BATCH_DATA_INDEX_SUB_4")
...
public class IBatchDataIndexSub5 extends DataObject{
	...
	public IBatchDataIndexSub5(){
	}

	public boolean equals(final Object rhs0){
		if (rhs0 == null)return false;
		IBatchDataIndexSub5 rhs=(IBatchDataIndexSub5)rhs0;
