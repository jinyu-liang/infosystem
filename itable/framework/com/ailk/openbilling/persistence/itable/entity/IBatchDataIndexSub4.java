...
@NotModified
@Entity
@Table(schema="JD",name="I_BATCH_DATA_INDEX_SUB_3")
...
public class IBatchDataIndexSub4 extends DataObject{
	...
	public IBatchDataIndexSub4(){
	}

	public boolean equals(final Object rhs0){
		if (rhs0 == null)return false;
		IBatchDataIndexSub4 rhs=(IBatchDataIndexSub4)rhs0;
