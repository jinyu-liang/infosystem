...
@NotModified
@Entity
@Table(schema="JD",name="I_BATCH_DATA_INDEX")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(propOrder={"custId","acctId","userId","upField","regionCode","countyCode","commitDate","doneCode","soNbr","remark","busiCode"})
public class IBatchDataIndex extends DataObject{
	...
	public IBatchDataIndex(){
	}

	public boolean equals(final Object rhs0){
		if (rhs0 == null)return false;
		IBatchDataIndex rhs=(IBatchDataIndex)rhs0;
...
public enum Field implements jef.database.Field{custId,acctId,userId,upField,regionCode,countyCode,commitDate,doneCode,soNbr,remark,busiCode}
}