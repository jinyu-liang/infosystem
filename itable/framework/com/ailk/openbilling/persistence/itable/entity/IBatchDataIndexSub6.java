...
@NotModified
@Entity
@Table(schema="JD",name="I_BATCH_DATA_INDEX_SUB_5")
...
public class IBatchDataIndexSub6 extends DataObject{
	...
	public IBatchDataIndexSub6(){
	}

	public boolean equals(final Object rhs0){
		if (rhs0 == null)return false;
		IBatchDataIndexSub6 rhs=(IBatchDataIndexSub6)rhs0;
