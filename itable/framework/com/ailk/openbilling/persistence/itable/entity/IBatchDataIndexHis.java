...
@NotModified
@Entity
@Table(schema="JD",name="I_BATCH_DATA_INDEX_HIS")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(propOrder={"custId","acctId","userId","upField","regionCode","countyCode","commitDate","doneCode","soNbr","dealDate","remark","busiCode"})
public class IBatchDataIndexHis extends DataObject{
	...
	public IBatchDataIndexHis(){
	}

	public boolean equals(final Object rhs0){
		if (rhs0 == null)return false;
		IBatchDataIndexHis rhs=(IBatchDataIndexHis)rhs0;
...
public enum Field implements jef.database.Field{custId,acctId,userId,upField,regionCode,countyCode,commitDate,doneCode,soNbr,dealDate,remark,busiCode}
}