...
@NotModified
@Entity
@Table(schema="JD",name="I_DATA_INDEX_NOTIFY")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(propOrder={"soNbr","custId","acctId","userId","upField","regionCode","countyCode","commitDate","doneCode","errorCode","errorMsg","errorDate","busiCode"})
public class IDataIndexNotify extends DataObject{
	...
	@Column(name="ERROR_DATE",columnDefinition="TimeStamp")
	...
	public IDataIndexNotify(){
	}

	public boolean equals(final Object rhs0){
		if (rhs0 == null)return false;
		IDataIndexNotify rhs=(IDataIndexNotify)rhs0;
...
public enum Field implements jef.database.Field{soNbr,custId,acctId,userId,upField,regionCode,countyCode,commitDate,doneCode,errorCode,errorMsg,errorDate,busiCode}
}