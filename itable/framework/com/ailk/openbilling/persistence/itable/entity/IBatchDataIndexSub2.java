...
@NotModified
@Entity
@Table(schema="JD",name="I_BATCH_DATA_INDEX_SUB_1")
...
public class IBatchDataIndexSub2 extends DataObject{
	...
	public IBatchDataIndexSub2(){
	}

	public boolean equals(final Object rhs0){
		if (rhs0 == null)return false;
		IBatchDataIndexSub2 rhs=(IBatchDataIndexSub2)rhs0;
