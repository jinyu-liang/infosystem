...
@NotModified
@Entity
@Table(schema="JD",name="I_BATCH_DATA_INDEX_SUB_0")
...
public class IBatchDataIndexSub1 extends DataObject{
	...
	public IBatchDataIndexSub1(){
	}

	public boolean equals(final Object rhs0){
		if (rhs0 == null)return false;
		IBatchDataIndexSub1 rhs=(IBatchDataIndexSub1)rhs0;
