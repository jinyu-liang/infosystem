...
@NotModified
@Entity
@Table(schema="JD",name="I_ACCTCHG_TRADE")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(propOrder={"soNbr","tradeId","sts","inDate","updateDate"})
public class IAcctchgTrade extends DataObject{
	...
	@Column(name="TRADE_ID",precision=8,columnDefinition="NUMBER",nullable=false)
	...
	public void setTradeId(Long obj){
		this.tradeId = obj;
	}
	...
	public IAcctchgTrade(){
	}

	public IAcctchgTrade(Long soNbr){
		this.soNbr = soNbr;
	}

	public boolean equals(final Object rhs0){
		if (rhs0 == null)return false;
		IAcctchgTrade rhs=(IAcctchgTrade)rhs0;
...
public enum Field implements jef.database.Field{soNbr,tradeId,sts,inDate,updateDate}
}