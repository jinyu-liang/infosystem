...
@NotModified
@Entity
@Table(schema="JD",name="I_BATCH_DATA_INDEX_SUB_6")
...
public class IBatchDataIndexSub7 extends DataObject{
	...
	public IBatchDataIndexSub7(){
	}

	public boolean equals(final Object rhs0){
		if (rhs0 == null)return false;
		IBatchDataIndexSub7 rhs=(IBatchDataIndexSub7)rhs0;
