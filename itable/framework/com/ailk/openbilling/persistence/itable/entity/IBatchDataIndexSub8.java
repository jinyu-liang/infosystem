...
@NotModified
@Entity
@Table(schema="JD",name="I_BATCH_DATA_INDEX_SUB_7")
...
public class IBatchDataIndexSub8 extends DataObject{
	...
	public IBatchDataIndexSub8(){
	}

	public boolean equals(final Object rhs0){
		if (rhs0 == null)return false;
		IBatchDataIndexSub8 rhs=(IBatchDataIndexSub8)rhs0;
