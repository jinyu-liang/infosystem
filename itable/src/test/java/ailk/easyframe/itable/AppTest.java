...
public class AppTest extends TestCase
{
    ...
    {
        // Date d = getFormatDate("20370620010101", "yyyyMMddHHmmss");
        // System.out.println(d.getTime() / 1000);
        long a = crc32(String.valueOf(31004913538L));
        a = a & 4294967295L;
        System.out.println(a % (long) 50);
    }

    // 1371661261 2129043661
    ...
    public static int crc32(String strChecked)
    {
        int table[] = { 0, 1996959894, -301047508, -1727442502, 124634137, 1886057615, -379345611, -1637575261, 249268274,
        ...
        byte bytes[] = strChecked.getBytes();
