...
public class TestQueryEcardInfo
{
...
//        sOper.setOp_id(1);
        ...
        Map map =new HashMap();
        map.put("sOper", sOper);
        QueryEcardReq req=new QueryEcardReq();
//        req.setResource_id(13365788lq);
        req.setPhone_id("34654r");
        map.put("req", req);
...
//        params.add(new BasicNameValuePair("resource_id", "10957"));
    ...
    public static void main(String[] args)
    {
        ...
        HttpPost httpPost = new HttpPost("http://10.10.142.235:18090/com.cmcc.sh.boss.interfaces.forcrm");
         httpPost.addHeader(HTTP.CONTENT_TYPE, "application/json");
//        httpPost.addHeader(HTTP.CONTENT_TYPE, "application/x-www-form-urlencoded");
         httpPost.addHeader("ClientId", "567eee8e");
