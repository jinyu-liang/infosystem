 ...
 * @Date 2012-4-19
 */
public class TestDoQueryPocketExt
{
...
//        pocketExtIn.setResource_id(10957L);
        pocketExtIn.setPhone_id("18701828244");
...
//        String pocketExtInStr = JsonUtil.serialize(pocketExtIn);
//        System.out.println("sOper paramter is: " + sOperStr);
//        System.out.println("pocketExtIn paramter is: " + pocketExtInStr);
...
//        System.out.println(JsonUtil.serialize(map));
        String ret = JsonUtil.serialize(map);
        return ret;
    ...
    public static void main(String[] args)
    {
        ...
        HttpPost httpPost = new HttpPost("http://10.10.107.67:53011/com.cmcc.sh.boss.interfaces.forcrm");
