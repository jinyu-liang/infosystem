...
public class DayBillCycleHandler extends BillCycleHandler {

	public DayBillCycleHandler(ChangeBillCycleContext billCycleContext,
			IMSContext context) {
	...
	public Date getFirstBillDate() {
    	...
    	cal.add(Calendar.DATE, billCycleContext.getBillCycle().getCycle_unit());

    	imsLogger.debug("DayHandler getFirstBillDate:"+cal.getTime());
		return cal.getTime();
	}
...
//        Date oldCycleEndDate = DateUtil.getFormatDate(oldCycleEnd, DateUtil.DATE_FORMAT_YYYYMMDD);
	...
	public void modifyShortBillCycleDelay() {
        ...
        */
        ...
        //计算expire_Date
        Date shortPlanEndDate = DateUtil.offsetDate(oldCycleEndDate, Calendar.DATE, newUnit);
	...
	public  static void main(String[] a){
		Calendar cal = Calendar.getInstance();
    	int dayOfWeek = cal.get(Calendar.HOUR_OF_DAY);
    	System.out.println(dayOfWeek);
    	dayOfWeek = cal.get(Calendar.HOUR);
    	System.out.println(dayOfWeek);
	}
