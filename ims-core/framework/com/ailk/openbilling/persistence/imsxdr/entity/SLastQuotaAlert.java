...
@Sdl(module="MXdr")
public class SLastQuotaAlert extends CsdlStructObject implements IComplexEntity{
	 ...
	 * 创建copy方法
	 */
	public SLastQuotaAlert(SLastQuotaAlert arg0){
		copy(arg0);
	}

	public void copy(final SLastQuotaAlert rhs){
		if (rhs == null)return;
	...
	public boolean equals(final Object rhs0){
		...
		SLastQuotaAlert rhs=(SLastQuotaAlert)rhs0;
...
public static final String SZ_TYPE_NAME = "com.ailk.openbilling.persistence.imsxdr.entity.SLastQuotaAlert";
@XmlTransient
...
static{
	memberTypeInfoList.add(MemberTypeInfo.get(SLastQuotaAlert.class, "ALARM_CODE", 0, SAocCode.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SLastQuotaAlert.class, "URL", 1, SUrlAddr.class));
}
