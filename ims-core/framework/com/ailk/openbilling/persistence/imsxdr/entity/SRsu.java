...
@Sdl(module="MXdr")
public class SRsu extends CsdlStructObject implements IComplexEntity{
	 ...
	 * 创建copy方法
	 */
	public SRsu(SRsu arg0){
		copy(arg0);
	}

	public void copy(final SRsu rhs){
		if (rhs == null)return;
...
public static final String SZ_TYPE_NAME = "com.ailk.openbilling.persistence.imsxdr.entity.SRsu";
@XmlTransient
...
static{
	memberTypeInfoList.add(MemberTypeInfo.get(SRsu.class, "MEASURE_ID", 0, int.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SRsu.class, "AMOUNT_RES", 1, long.class));
}
