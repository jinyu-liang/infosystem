...
@Sdl(module="MXdr")
public class SAccumulateAlarm extends CsdlStructObject implements IComplexEntity{
	 ...
	 * 创建copy方法
	 */
	public SAccumulateAlarm(SAccumulateAlarm arg0){
		copy(arg0);
	}

	public void copy(final SAccumulateAlarm rhs){
		if (rhs == null)return;
	...
	public boolean equals(final Object rhs0){
		...
		SAccumulateAlarm rhs=(SAccumulateAlarm)rhs0;
...
public static final String SZ_TYPE_NAME = "com.ailk.openbilling.persistence.imsxdr.entity.SAccumulateAlarm";
@XmlTransient
...
static{
	memberTypeInfoList.add(MemberTypeInfo.get(SAccumulateAlarm.class, "ALARM_RULE_ID", 0, int.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SAccumulateAlarm.class, "DONE_CODE", 1, long.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SAccumulateAlarm.class, "VALID_DATE_TIME", 2, long.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SAccumulateAlarm.class, "EXPIRE_DATE_TIME", 3, long.class));
}
