...
@XmlType(propOrder={"url","alarmType","priceId","doneCode","validDate","expireDate","salarmAddup"})
@Sdl(module="MXdr")
public class SAccumulatePriceUrlAddr extends CsdlStructObject implements IComplexEntity{
	...
	public SAccumulatePriceUrlAddr(){
	 ...
	 * 创建copy方法
	 */
	public SAccumulatePriceUrlAddr(SAccumulatePriceUrlAddr arg0){
		copy(arg0);
	}

	public void copy(final SAccumulatePriceUrlAddr rhs){
		if (rhs == null)return;
	...
	public boolean equals(final Object rhs0){
		...
		SAccumulatePriceUrlAddr rhs=(SAccumulatePriceUrlAddr)rhs0;
...
public static final String SZ_TYPE_NAME = "com.ailk.openbilling.persistence.imsxdr.entity.SAccumulatePriceUrlAddr";
@XmlTransient
...
static{
	memberTypeInfoList.add(MemberTypeInfo.get(SAccumulatePriceUrlAddr.class, "URL", 0, SUrlAddr.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SAccumulatePriceUrlAddr.class, "ALARM_TYPE", 1, int.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SAccumulatePriceUrlAddr.class, "PRICE_ID", 2, int.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SAccumulatePriceUrlAddr.class, "DONE_CODE", 3, long.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SAccumulatePriceUrlAddr.class, "VALID_DATE", 4, long.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SAccumulatePriceUrlAddr.class, "EXPIRE_DATE", 5, long.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SAccumulatePriceUrlAddr.class, "SALARM_ADDUP", 6, List.class));
}
