...
@XmlType(propOrder={"changeItemId","doneCode","priceId"})
@Sdl(module="MXdr")
public class SPriceTrace extends CsdlStructObject implements IComplexEntity{
	 ...
	 * 创建copy方法
	 */
	public SPriceTrace(SPriceTrace arg0){
		copy(arg0);
	}

	public void copy(final SPriceTrace rhs){
		if (rhs == null)return;
	...
	public boolean equals(final Object rhs0){
		...
		SPriceTrace rhs=(SPriceTrace)rhs0;
...
public static final String SZ_TYPE_NAME = "com.ailk.openbilling.persistence.imsxdr.entity.SPriceTrace";
@XmlTransient
...
static{
	memberTypeInfoList.add(MemberTypeInfo.get(SPriceTrace.class, "CHANGE_ITEM_ID", 0, int.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SPriceTrace.class, "DONE_CODE", 1, long.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SPriceTrace.class, "PRICE_ID", 2, int.class));
}
