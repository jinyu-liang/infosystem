...
@XmlType(propOrder={"soNbr","busiCode","soMode","soDate","chargeFlag","isnormal","custId","acctId","userId","phoneId","opId","provCode","regionCode","countyCode","orgId","rsoNbr","isMonitor","remark"})
@Sdl(module="MXdr")
public class SOperInfo extends CsdlStructObject implements IComplexEntity{
	...
	public final static int IDX_SO_DATE = 3;
	public final static int IDX_CHARGE_FLAG = 4;
	public final static int IDX_ISNORMAL = 5;
	public final static int IDX_CUST_ID = 6;
	public final static int IDX_ACCT_ID = 7;
	public final static int IDX_USER_ID = 8;
	public final static int IDX_PHONE_ID = 9;
	public final static int IDX_OP_ID = 10;
	public final static int IDX_PROV_CODE = 11;
	public final static int IDX_REGION_CODE = 12;
	public final static int IDX_COUNTY_CODE = 13;
	public final static int IDX_ORG_ID = 14;
	public final static int IDX_RSO_NBR = 15;
	public final static int IDX_IS_MONITOR = 16;
	public final static int IDX_REMARK = 17;
...
public static final String SZ_TYPE_NAME = "com.ailk.openbilling.persistence.imsxdr.entity.SOperInfo";
@XmlTransient
...
static{
	...
	memberTypeInfoList.add(MemberTypeInfo.get(SOperInfo.class, "SO_DATE", 3, long.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SOperInfo.class, "CHARGE_FLAG", 4, short.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SOperInfo.class, "ISNORMAL", 5, short.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SOperInfo.class, "CUST_ID", 6, long.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SOperInfo.class, "ACCT_ID", 7, long.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SOperInfo.class, "USER_ID", 8, long.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SOperInfo.class, "PHONE_ID", 9, String.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SOperInfo.class, "OP_ID", 10, int.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SOperInfo.class, "PROV_CODE", 11, short.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SOperInfo.class, "REGION_CODE", 12, short.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SOperInfo.class, "COUNTY_CODE", 13, short.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SOperInfo.class, "ORG_ID", 14, int.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SOperInfo.class, "RSO_NBR", 15, String.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SOperInfo.class, "IS_MONITOR", 16, short.class));
	memberTypeInfoList.add(MemberTypeInfo.get(SOperInfo.class, "REMARK", 17, String.class));
}
