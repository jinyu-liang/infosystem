...
@Sdl(module="MXdr")
public class STapCamelVatAmt extends CsdlStructObject implements IComplexEntity{
	 ...
	 * 创建copy方法
	 */
	public STapCamelVatAmt(STapCamelVatAmt arg0){
		copy(arg0);
	}

	public void copy(final STapCamelVatAmt rhs){
		if (rhs == null)return;
	...
	public boolean equals(final Object rhs0){
		...
		STapCamelVatAmt rhs=(STapCamelVatAmt)rhs0;
...
public static final String SZ_TYPE_NAME = "com.ailk.openbilling.persistence.imsxdr.entity.STapCamelVatAmt";
@XmlTransient
...
static{
	memberTypeInfoList.add(MemberTypeInfo.get(STapCamelVatAmt.class, "FEE", 0, long.class));
	memberTypeInfoList.add(MemberTypeInfo.get(STapCamelVatAmt.class, "MEASURE_ID", 1, int.class));
}
