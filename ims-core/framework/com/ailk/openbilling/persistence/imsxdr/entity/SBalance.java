...
@XmlType(propOrder={"bookId","bookItem","amount","days","acctId","userId","phoneId","validDate","expireDate","extraMap"})
@Sdl(module="MXdr")
...
public static final String SZ_TYPE_NAME = "com.ailk.openbilling.persistence.imsxdr.entity.SBalance";
@XmlTransient
...
static{
	...
	memberTypeInfoList.add(MemberTypeInfo.get(SBalance.class, "EXTRA_MAP", 9, Map.class));
}
