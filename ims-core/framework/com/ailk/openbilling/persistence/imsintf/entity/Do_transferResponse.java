...
@XmlType(propOrder={"sBalanceList","freeResourceList"})
public class Do_transferResponse extends BaseResponse implements IComplexEntity{
	...
	public boolean equals(final Object rhs0){
		...
		Do_transferResponse rhs=(Do_transferResponse)rhs0;
