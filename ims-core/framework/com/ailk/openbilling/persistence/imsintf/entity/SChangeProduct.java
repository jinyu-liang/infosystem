...
@XmlType(propOrder={"outer_cust_id","cust_id","outer_acct_id","acct_id","user_id","phone_id","prod_order_list","keep_ics_list"})
public class SChangeProduct implements IComplexEntity{
	...
	public void setKeep_ics_list(Short obj){
		this.keep_ics_list = obj;
	}

	public Short getKeep_ics_list(){
		return keep_ics_list;
	}

	public boolean equals(final Object rhs0){
		if (rhs0 == null)return false;
		SChangeProduct rhs=(SChangeProduct)rhs0;
		...
		if(!ObjectUtils.equals(keep_ics_list, rhs.keep_ics_list)) return false;
		return true;
	}
