...
@XmlType(propOrder={"invoice_no","outer_cust_id","cust_id","outer_acct_id","acct_id","outer_pay_acct_id","pay_acct_id","user_id","phone_id","bill_cycle_no","cycle_begin_date","cycle_end_date","unpay_fee","discount_fee","adjust_fee","prim_fee","billUsageItemList"})
public class BillUsage implements IComplexEntity{


	@XmlElement(name="billUsageItemList")
	private BillUsageItemList billUsageItemList;
	...
	public void setBillUsageItemList(BillUsageItemList obj){
		this.billUsageItemList = obj;
	}
	...
	public boolean equals(final Object rhs0){
		...
		BillUsage rhs=(BillUsage)rhs0;
		if(!ObjectUtils.equals(billUsageItemList, rhs.billUsageItemList)) return false;
