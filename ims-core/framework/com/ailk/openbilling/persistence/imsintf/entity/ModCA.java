...
@XmlType(propOrder={"outer_cust_id","cust_id","outer_acct_id","acct_id","user_list"})
public class ModCA implements IComplexEntity{


	@XmlElement(name="user_list")
	private SModSubscriberList user_list;
	...
	public void setUser_list(SModSubscriberList obj){
		this.user_list = obj;
	}

	public SModSubscriberList getUser_list(){
		return user_list;
	}
