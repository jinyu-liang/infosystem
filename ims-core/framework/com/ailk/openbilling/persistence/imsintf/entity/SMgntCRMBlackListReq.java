...
@XmlType(propOrder={"user_id","phone_id","oper_type"})
public class SMgntCRMBlackListReq implements IComplexEntity{
	...
	public boolean equals(final Object rhs0){
		...
		SMgntCRMBlackListReq rhs=(SMgntCRMBlackListReq)rhs0;
