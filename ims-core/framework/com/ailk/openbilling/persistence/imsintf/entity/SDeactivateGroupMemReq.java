...
@XmlType(propOrder={"outer_group_id","group_id","change_sts","sMemStsList"})
public class SDeactivateGroupMemReq implements IComplexEntity{


	@XmlElement(name="sMemStsList")
	private SMemStsList sMemStsList;
	...
	public void setSMemStsList(SMemStsList obj){
		this.sMemStsList = obj;
	}
	...
	public boolean equals(final Object rhs0){
		...
		SDeactivateGroupMemReq rhs=(SDeactivateGroupMemReq)rhs0;
		if(!ObjectUtils.equals(sMemStsList, rhs.sMemStsList)) return false;
