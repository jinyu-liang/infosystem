...
@XmlType(propOrder={"outer_cust_id","cust_id","outer_acct_id","acct_id","sub_ca_list"})
public class SCARelateReq implements IComplexEntity{


	@XmlElement(name="sub_ca_list")
	private SubCAList sub_ca_list;
	...
	public void setSub_ca_list(SubCAList obj){
		this.sub_ca_list = obj;
	}

	public SubCAList getSub_ca_list(){
		return sub_ca_list;
	}
	...
	public boolean equals(final Object rhs0){
		...
		SCARelateReq rhs=(SCARelateReq)rhs0;
		if(!ObjectUtils.equals(sub_ca_list, rhs.sub_ca_list)) return false;
