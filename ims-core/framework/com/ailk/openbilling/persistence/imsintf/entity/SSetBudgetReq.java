...
@XmlType(propOrder={"outer_cust_id","cust_id","outer_acct_id","acct_id","user_id","phone_id","temp_flag","budget_control_list"})
public class SSetBudgetReq implements IComplexEntity{


	@XmlElement(name="budget_control_list")
	private BudgetList budget_control_list;
	...
	public void setBudget_control_list(BudgetList obj){
		this.budget_control_list = obj;
	}

	public BudgetList getBudget_control_list(){
		return budget_control_list;
	}
	...
	public boolean equals(final Object rhs0){
		...
		SSetBudgetReq rhs=(SSetBudgetReq)rhs0;
		if(!ObjectUtils.equals(budget_control_list, rhs.budget_control_list)) return false;
