...
@XmlType(propOrder={"sCustomerList","sContactList","sAccountList","sUserList","sProductList"})
public class Do_queryCustomerHistoryForGUIResponse extends BaseResponse implements IComplexEntity{
	...
	@XmlElement(name="sProductList")
	private SProductOrderListHistory sProductList;
	...
	public void setSProductList(SProductOrderListHistory obj){
		this.sProductList = obj;
	}

	public SProductOrderListHistory getSProductList(){
		return sProductList;
	}

	public boolean equals(final Object rhs0){
		if (rhs0 == null)return false;
		Do_queryCustomerHistoryForGUIResponse rhs=(Do_queryCustomerHistoryForGUIResponse)rhs0;
		...
		if(!ObjectUtils.equals(sProductList, rhs.sProductList)) return false;
		return true;
	}
