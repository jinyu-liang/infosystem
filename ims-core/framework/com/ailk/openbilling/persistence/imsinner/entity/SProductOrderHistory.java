...
@XmlType(propOrder={"product_id","offer_id","offering_name","so_id","product_type","parent_serv_product","outer_cust_id","cust_id","outer_acct_id","acct_id","user_id","phone_id","outer_billable_acct_id","billable_acct_id","billing_type","prod_state","create_date","valid_type","valid_date","expire_date","nextcycle_start_date","bill_cycle","reguid_price_param","param_list","price_description"})
public class SProductOrderHistory implements IComplexEntity{
	...
	public void setOffering_name(String obj){
		this.offering_name = obj;
	}
	...
	public boolean equals(final Object rhs0){
		...
		SProductOrderHistory rhs=(SProductOrderHistory)rhs0;
		...
		if(!ObjectUtils.equals(offering_name, rhs.offering_name)) return false;
