...
@XmlType(propOrder={"gui_cust_id","gui_acct_id","gui_user_id","gui_phone_id"})
public class SQuerySCustomersReq implements IComplexEntity{
	...
	public boolean equals(final Object rhs0){
		...
		SQuerySCustomersReq rhs=(SQuerySCustomersReq)rhs0;
