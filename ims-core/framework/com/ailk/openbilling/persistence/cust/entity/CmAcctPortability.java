...
@NotModified
@Entity
@Table(schema="cd",name="CM_ACCT_PORTABILITY")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(propOrder={"acctId","outRegion","inRegion","regionCode","createDate","soDate","soNbr","validDate","expireDate","remark"})
public class CmAcctPortability extends DataObject{
	...
	public CmAcctPortability(){
	}

	public CmAcctPortability(Long acctId,Long soNbr,Date validDate){
		this.acctId = acctId;
		this.soNbr = soNbr;
	...
	public boolean equals(final Object rhs0){
		...
		CmAcctPortability rhs=(CmAcctPortability)rhs0;
...
public enum Field implements jef.database.Field{acctId,outRegion,inRegion,regionCode,createDate,soDate,soNbr,validDate,expireDate,remark}
}