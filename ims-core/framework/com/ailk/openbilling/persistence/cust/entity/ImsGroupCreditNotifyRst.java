...
@NotModified
@Entity
@Table(schema="CD",name="IMS_GROUP_CREDIT_NOTIFY_RST")
...
public class ImsGroupCreditNotifyRst extends DataObject{
	...
	public ImsGroupCreditNotifyRst(){
	}

	public ImsGroupCreditNotifyRst(Long hisId){
		this.hisId = hisId;
	}

	public boolean equals(final Object rhs0){
		if (rhs0 == null)return false;
		ImsGroupCreditNotifyRst rhs=(ImsGroupCreditNotifyRst)rhs0;
