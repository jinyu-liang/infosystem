...
@NotModified
@Entity
@Table(schema="CD",name="CM_FIRST_ACTIVE_TASK")
...
public class CmFirstActiveTask extends DataObject{
...
--WRITING_LANGUAGE
	...
	public CmFirstActiveTask(){
	}

	public boolean equals(final Object rhs0){
		if (rhs0 == null)return false;
		CmFirstActiveTask rhs=(CmFirstActiveTask)rhs0;
