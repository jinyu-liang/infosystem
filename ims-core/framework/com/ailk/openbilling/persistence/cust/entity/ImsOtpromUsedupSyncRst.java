...
@NotModified
@Entity
@Table(schema="cd",name="IMS_OTPROM_USEDUP_SYNC_RST")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(propOrder={"id","acctId","custId","resourceId","phoneId","productId","productOffceId","usedUpTime","extendField1","extendField2","soNbr","createDate","dealDate","sts","dealDesc","dealAgainDate","levelType","errorMsg","errorCode","dealCount"})
public class ImsOtpromUsedupSyncRst extends DataObject{


	/**
	 * ำษbosฯตอณsequenceฒ๚ษ๚
	 */
	...
	public ImsOtpromUsedupSyncRst(){
	}

	public ImsOtpromUsedupSyncRst(Long id){
		this.id = id;
	}

	public boolean equals(final Object rhs0){
		if (rhs0 == null)return false;
		ImsOtpromUsedupSyncRst rhs=(ImsOtpromUsedupSyncRst)rhs0;
...
public enum Field implements jef.database.Field{id,acctId,custId,resourceId,phoneId,productId,productOffceId,usedUpTime,extendField1,extendField2,soNbr,createDate,dealDate,sts,dealDesc,dealAgainDate,levelType,errorMsg,errorCode,dealCount}
}