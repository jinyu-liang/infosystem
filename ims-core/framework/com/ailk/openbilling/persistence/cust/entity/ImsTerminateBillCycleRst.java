...
public class ImsTerminateBillCycleRst extends DataObject{
	...
	public ImsTerminateBillCycleRst(){
	}

	public boolean equals(final Object rhs0){
		if (rhs0 == null)return false;
		ImsTerminateBillCycleRst rhs=(ImsTerminateBillCycleRst)rhs0;
		if(!ObjectUtils.equals(id, rhs.id)) return false;
		if(!ObjectUtils.equals(acctId, rhs.acctId)) return false;
		if(!ObjectUtils.equals(actionDate, rhs.actionDate)) return false;
		if(!ObjectUtils.equals(billSts, rhs.billSts)) return false;
