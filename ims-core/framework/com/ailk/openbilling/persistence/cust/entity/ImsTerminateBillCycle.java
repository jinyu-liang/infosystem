...
public class ImsTerminateBillCycle extends DataObject{
	...
	public ImsTerminateBillCycle(){
	}

	public ImsTerminateBillCycle(long id){
		this.id = id;
	}

	public boolean equals(final Object rhs0){
		if (rhs0 == null)return false;
		ImsTerminateBillCycle rhs=(ImsTerminateBillCycle)rhs0;
